...
## Further Reading
* Jonas Bon&eacute;r, [http://www.slideshare.net/jboner/state-youre-doing-it-wrong-javaone-2009 State: You're Doing It Wrong - Alternative Concurrency Paradigms For The JVM] -- this is a presentation by the creator of the akka library for Scala, which provides implementations of most of the techniques discussed above.
